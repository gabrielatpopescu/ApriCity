...
<Card.Root class="@container/card">
	<Card.Header class="">
		<Card.Title class="">Total Visitors</Card.Title>
		...
		<Card.Action class="">
			...
			>
				<ToggleGroup.Item class="" value="90d" size="default" variant="default">Last 3 months</ToggleGroup.Item>
				<ToggleGroup.Item class="" value="30d" size="default" variant="default">Last 30 days</ToggleGroup.Item>
				<ToggleGroup.Item class="" value="7d" size="default" variant="default">Last 7 days</ToggleGroup.Item>
			</ToggleGroup.Root>
			<Select.Root type="single" bind:value={timeRange}>
				...
				<Select.Content class="rounded-xl" portalProps={{}}>
					<Select.Item value="90d" class="rounded-lg" label="Last 3 months">Last 3 months</Select.Item>
					<Select.Item value="30d" class="rounded-lg" label="Last 30 days">Last 30 days</Select.Item>
					<Select.Item value="7d" class="rounded-lg" label="Last 7 days">Last 7 days</Select.Item>
				</Select.Content>
			</Select.Root>
		</Card.Action>
	</Card.Header>
